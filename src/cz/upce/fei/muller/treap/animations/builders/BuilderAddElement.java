...
import cz.upce.fei.muller.treap.animations.handlers.InsertingEndEventHandler;
...
public class BuilderAddElement extends BuilderAnimMoveNode {
    ...
    public BuilderAddElement(Point2D to, Point2D creatingPoint, TreapGraphicElement element) {
