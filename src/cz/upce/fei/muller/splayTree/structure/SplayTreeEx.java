package cz.upce.fei.muller.splayTree.structure;// Splay trees - Nils Anders Danielsson

// The documentation of the code below is based on the assumption that
// the reader already knows what a splay tree is.

// Pointer manipulation can be easy to get wrong, but many bugs can be
// discovered through thorough testing. Think about how the code below
// can be tested!
 ...
 */
public class SplayTreeEx<A extends Comparable<? super A>> {
